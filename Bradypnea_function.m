...
%分段生成呼吸信号
for i =1:N+1
    %Bradypnea a在0.3至0.5随机，b在0.79至1.15随机，c在-0.4至+0.4随机，d在-0.1至0.1随机
    C{i,2} =  Breathing(C{i,1},randa2b(0.3,0.5,1),randa2b(0.79,1.15,1),randa2b(-0.4,0.4,1),randa2b(-0.1,0.1,1));
end
%连接N个断点
