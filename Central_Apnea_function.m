...
%分段生成呼吸信号
    for i =1:N+1
        %Central Apnea 正常呼吸阶段 a在0.3至0.6随机，b在1.37至1.77随机，c在-0.4至+0.4随机，d在-0.1至+0.1随机
        C{i+T*(N+2),2} =  Breathing(C{i+T*(N+2),1},randa2b(0.3,0.6,1),randa2b(1.37,1.77,1),randa2b(-0.4,0.4,1),randa2b(-0.1,0.1,1));
    end
%Biots窒息阶段
%a在-0.05至0.05随机，b在0.01至3.14随机，c在-0.4至+0.4随机，d在-0.01至0.01随机
C{N+2+T*(N+2),2}= Breathing(C{N+2+T*(N+2),1},randa2b(-0.05,0.05,1),randa2b(0.01,3.14,1),randa2b(-0.4,0.4,1),randa2b(-0.01,0.01,1));
